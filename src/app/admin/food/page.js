  ...
  return (
    <div className="space-y-6 animate-in fade-in duration-500">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground">Cập nhật danh sách thực đơn của bạn</p>
          </div>
        </div>
        <button
          onClick={() => handleOpenModal()}
          className="w-full sm:w-auto flex items-center justify-center gap-2 px-6 py-2.5 bg-primary hover:bg-primary-dark text-primary-foreground rounded-lg transition-all font-bold cursor-pointer shadow-sm active:scale-95"
        >
      ...
      <div className="bg-card rounded-xl border border-border p-3 sm:p-4 space-y-3 sm:space-y-4 shadow-sm">
        <div className="flex flex-col sm:flex-row gap-2 sm:gap-4">
          <div className="flex-1 flex gap-2">
            ...
            <button
              ...
              className={`sm:hidden flex items-center justify-center gap-1.5 px-3 py-2 rounded-lg border transition-all ${showMobileFilters || activeFiltersCount > 0
        ...
        {/* Collapsible Selects */}
        <div className={`${showMobileFilters ? 'grid' : 'hidden'} sm:grid grid-cols-1 sm:grid-cols-2 gap-3 pt-2 sm:pt-0 border-t sm:border-none border-border animate-in slide-in-from-top-2 duration-200`}>
          {/* Category Filter */}
          <div className="relative">
            ...
            <select
              ...
              className="w-full pl-9 sm:pl-10 pr-8 py-2 bg-muted/30 border border-border rounded-lg text-xs sm:text-sm text-card-foreground focus:outline-none focus:ring-2 focus:ring-primary/50 appearance-none transition-all"
            >
          ...
          <div className="relative">
            ...
            >
              ...
              <option value="true">Còn món (Có sẵn)</option>
              <option value="false">Hết món (Tạm hết)</option>
            </select>
            <ChevronDown className="absolute right-3 top-1/2 -translate-y-1/2 w-3 h-3 text-muted-foreground pointer-events-none" />
          </div>
          ...
          {activeFiltersCount > 0 && (
            ...
            >
              <X className="w-3 h-3" /> Thiết lập lại bộ lọc
            </button>
          )}
        </div>
      </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full px-4 py-2 bg-input border border-border rounded-lg text-card-foreground focus:outline-none focus:ring-2 focus:ring-ring min-h-24"
